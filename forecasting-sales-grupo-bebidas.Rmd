...
<br>
<hr>
<center><div><b style="font-size:22px;">Previsão de Grupo de Bebidas</b></div></center>
<hr>
```{r include=FALSE}
library('forecast')
library('plotly')
...
<hr>
<span>Na análise de estacionaridade do grupo de bebidas. Para p-value < <b>0.05</b> indica que a série possui comportamento estacionário.</span>
...
<hr>
<center><div><b style="font-size:22px;">Visualização da Previsão de Grupo de Bebidas - 1 Semestre de 2017</b></div></center>
<hr>
<br>
